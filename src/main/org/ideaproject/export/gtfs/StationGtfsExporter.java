 ...
 *
 */
public class StationGtfsExporter extends AbstractGtfsExporter<Station> {
	private static final Object BUFFER_LOCK = new Object();
	private static final StringBuffer BUFFER = new StringBuffer(255);
	@Logger
	private Log logger;

	public void export(Station toExport, OutputStream outStream)
			throws IOException {
		...
		BUFFER.append(SEPARATOR);
		BUFFER.append(Constants.STATION_LOCATION_TYPE_ID);
		BUFFER.append(SEPARATOR);
